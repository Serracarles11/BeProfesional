...
"[project]/beprofesional/lib/supabase/env.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/beprofesional/proxy.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$beprofesional$2f$lib$2f$supabase$2f$env$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/beprofesional/lib/supabase/env.ts [middleware] (ecmascript)");
;
;
;
async function proxy(request) {
    let response = __TURBOPACK__imported__module__$5b$project$5d2f$beprofesional$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next({
        request: {
            headers: request.headers
        }
    });
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$beprofesional$2f$lib$2f$supabase$2f$env$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["isSupabaseConfigured"])()) {
        return response;
    }
    const { url, anonKey } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$beprofesional$2f$lib$2f$supabase$2f$env$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["getSupabaseEnv"])();
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$beprofesional$2f$node_modules$2f2e$pnpm$2f40$supabase$2b$ssr$40$0$2e$6$2e$1_$40$supabase$2b$supabase$2d$js$40$2$2e$94$2e$1$2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["createServerClient"])(url, anonKey, {
        cookies: {
            ...
            set (name, value, options) {
                ...
                response = __TURBOPACK__imported__module__$5b$project$5d2f$beprofesional$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next({
                    request: {
                        headers: request.headers
                    }
                });
    ...
    if (!session) {
        ...
        if (isProtectedRoute || isOnboardingRoute) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$beprofesional$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/login', request.url));
        }
        return response;
    }
    ...
    if (isAuthRoute) {
        if (perfilCompleto) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$beprofesional$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/equipos', request.url));
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bcf27e5b._.js.map